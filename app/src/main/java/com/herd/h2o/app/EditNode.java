...
public class EditNode extends Activity {
    ...
    private static final String DELETE_NODE_URL = "http://192.168.42.1/deletenode.php"; //running on pi
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder deleteDialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Confirm", new DialogInterface.OnClickListener()
                {
                    ...
                    {
                        new DeleteNode().execute();//continue with the delete
                    }
                })
    ...
    class EditTheNode extends AsyncTask<String, String, String> {
        @Override
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                params.add(new BasicNameValuePair("active", node_active));
    ...
    class DeleteNode extends AsyncTask<String, String, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            ...
            //set up the progress dialog to show that the node is trying to be added
            pDialog = new ProgressDialog(EditNode.this);
            pDialog.setMessage("Deleting Node...");
            pDialog.setIndeterminate(false);
            pDialog.setCancelable(true);
            pDialog.show();
        }
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                //Posting user data to script
                JSONObject json = jsonParser.makeHttpRequest(
                        DELETE_NODE_URL, "POST", params);

                // fulld json response
                Log.d("Delete Node Attempt", json.toString());

                // json success element
                success = json.getInt(TAG_SUCCESS);
                if (success == 1) {
                    Log.d("Node Deleted!", json.toString());
                    finish();
                    return json.getString(TAG_MESSAGE);
                }else{
                    Log.d("Delete Node Failure!", json.getString(TAG_MESSAGE));
                    return json.getString(TAG_MESSAGE);
